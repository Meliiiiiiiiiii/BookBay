<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReceiptManagementSystemLogin.aspx.cs" Inherits="ReceiptManagementSystemLogin" %>
...
<body style="height: 473px">
    <form id="form1" runat="server">
        ...
        <asp:Label ID="Label1" runat="server" style="z-index: 1; left: 450px; top: 49px; position: absolute" Text="Receipt Management System"></asp:Label>
        ...
        <asp:Button ID="btnCancel" runat="server" style="z-index: 1; left: 592px; top: 265px; position: absolute" Text="Cancel" />
