<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CustomerManagementSystemLogin.aspx.cs" Inherits="CustomerLogin" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Label ID="Label1" runat="server" style="z-index: 1; left: 169px; top: 65px; position: absolute" Text="Customer Management System Login Page"></asp:Label>
