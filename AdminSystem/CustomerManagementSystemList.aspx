...
<body>
    <form id="form1" runat="server">
     ...
     <asp:ListBox ID="lstCustomerList" runat="server" style="z-index: 1; left: 30px; top: 32px; position: absolute; height: 477px; width: 784px"></asp:ListBox>
     <asp:Button ID="btnAdd" runat="server" OnClick="btnAdd_Click" style="z-index: 1; left: 30px; top: 540px; position: absolute" Text="Add" />
     <asp:Label ID="Label1" runat="server" style="z-index: 1; left: 32px; top: 612px; position: absolute; height: 20px; width: 146px" Text="Enter a Date"></asp:Label>
     <asp:TextBox ID="txtDateFilter" runat="server" style="z-index: 1; left: 168px; top: 613px; position: absolute; width: 286px"></asp:TextBox>
